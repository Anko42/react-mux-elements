...
type HTMLVideoElementWithoutOverrides = Pick<HTMLVideoElement, Exclude<keyof HTMLVideoElement, 'autoplay'>>;
...
// it extends an HTMLVideoElement.
 extends HTMLVideoElement implements HTMLVideoElementWithoutOverrides {
